...
var min = function(num1,num2,num3,num4) {
...
var oneString = function(input1,input2) {
	if (input1 && input2 === 'string') {
		return false
	}
	else if (input1 && input2 !== 'string') {
		return false
	}
	else {
		return true
...
var doTwice = function(helloWorld) {
	helloWorld * 2
}
...
var conditionallyInvoke = function(helloWorld) {
if (ORACLE = 'YES') {
	console.log('hello world')
}
}
